...
class ModelCatalogProduct extends Model {
	...
	public function OriggetProductOptions($product_id) {
	...
	public function getProductOptions($product_id, $seller_id) {
		...
		foreach ($product_option_query->rows as $product_option) {
			...
			LEFT JOIN seller_product_option_value spov ON (pov.option_value_id = spov.option_value_id) 
			WHERE pov.product_id = '" . (int)$product_id . "' 
			AND pov.product_option_id = '" . (int)$product_option['product_option_id'] . "' 
			AND spov.seller_option_id = '" . (int)$product_option['seller_option_id'] . "'
			ORDER BY spov.sort_order
			");

			foreach ($product_option_value_query->rows as $product_option_value) {
				$product_option_value_data[] = array(
					'product_option_value_id' => $product_option_value['option_value_id'],
					'option_value_id'         => $product_option_value['option_value_id'],
					'name'                    => $product_option_value['value'],
					'image'                   => $product_option_value['image'],
					'quantity'                => $product_option_value['quantity'],
					'subtract'                => $product_option_value['subtract'],
					'price'                   => $product_option_value['price'],
			...
			$product_option_data[] = array(
				'product_option_id'    => $product_option['seller_option_id'],
				'product_option_value' => $product_option_value_data,
				'option_id'            => $product_option['seller_option_id'],
				'name'                 => $product_option['name'],
				'type'                 => $product_option['type'],
				'value'                => $product_option['value'],
				'required'             => $product_option['required']
