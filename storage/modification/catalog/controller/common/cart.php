		...
		foreach ($this->cart->getProducts() as $product) {
			...
			if ($this->customer->isLogged() || !$this->config->get('config_customer_price')) {
				...
				$total = false;
                            ...
                            $sellerInfo = $this->model_customerpartner_master->checkIsSellerProduct($product['product_id']);
			...
			$data['products'][] = array(
				...
				'total'     => $total,
                             ...
                             'seller_name'     => !empty($sellerInfo) ? $sellerInfo[$product['product_id']]['seller_name'] : '',
                             'seller_href'      => !empty($sellerInfo) ? $sellerInfo[$product['product_id']]['seller_href'] : '',
