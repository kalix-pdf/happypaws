...
class ControllerProductCategory extends Controller {
	public function index() {
        ...
        $price = $this->currency->format($commission_amount + $this->tax->calculate($result['price'], $result['tax_class_id'], $this->config->get('config_tax')), $this->session->data['currency']);
