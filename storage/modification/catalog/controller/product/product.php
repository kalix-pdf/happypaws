	...
	public function index() {
		...
		if ($product_info) {
			...
			if ($this->customer->isLogged() || !$this->config->get('config_customer_price')) {
                  ...
                  $data['price'] = $this->currency->format($product_info['commission_amount'] + $this->tax->calculate($product_info['price']- $product_info['commission_amount'], $product_info['tax_class_id'], $this->config->get('config_tax')), $this->session->data['currency']);
