...
class ControllerProductCompare extends Controller {
	public function index() {
        ...
        $price = $this->currency->format($product_info['commission_amount'] + $this->tax->calculate($product_info['price'] - $product_info['commission_amount'], $product_info['tax_class_id'], $this->config->get('config_tax')), $this->session->data['currency']);
        ...
        $sellerInfo = $this->model_customerpartner_master->checkIsSellerProduct($product_id);
