...
class ControllerStartupStartup extends Controller {
	...
	public function index() {
		...
		// Customer
               ...
               */
               if (isset($this->request->post['customer_id']) && $this->request->post['customer_id']) {
                 ...
                 if (isset($raw_data['customer_id']) && $raw_data['customer_id']) {
                   $this->session->data['customer_id'] = $raw_data['customer_id'];
                 }
               }
              /**
               * ends here
        ...
        // Marketplace seperate seller view
        if($this->config->get('marketplace_seller_redirect_seperate') &&
          ( (!empty($this->session->data['marketplace_separate_view'])  &&  $this->session->data['marketplace_separate_view'] == 'default') ||
          (empty($this->session->data['marketplace_separate_view']))) ) {			
