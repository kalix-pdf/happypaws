...
/* __string_template__d9fe3d408226596cdd2d18a07c262aa65119a832e4597bc08905e8aad001e2d5 */
class __TwigTemplate_2c90f9e6abf044c9d2159b4ddd9c5e8978fed5cb4a824cdff02278d183cb4a7d extends Template
{
    private $source;
    private $macros = [];
      ...
      <div class=\"caption\">
        ...
        ";
            ...
            if (twig_get_attribute($this->env, $this->source, $context["product"], "rating", [], "any", false, false, false, 11)) {
                // line 12
                echo "        <div class=\"rating d-flex gap-3\">
          ";
                // line 13
                $context['_parent'] = $context;
...
";
    ...
    {
        return "__string_template__d9fe3d408226596cdd2d18a07c262aa65119a832e4597bc08905e8aad001e2d5";
    }
    ...
    {
        return new Source("", "__string_template__d9fe3d408226596cdd2d18a07c262aa65119a832e4597bc08905e8aad001e2d5", "");
    }
}
