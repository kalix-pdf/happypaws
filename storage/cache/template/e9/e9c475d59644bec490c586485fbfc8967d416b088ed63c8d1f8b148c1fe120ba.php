...
class __TwigTemplate_4f2f937a2b80f16fc6b9ee7b7c026ee5fb7af340c3c96f8dd961fde43db83c5b extends Template
{
    private $source;
    private $macros = [];
                ...
                <td class=\"text-right\">
                  <span class=\"text-success\">";
                    ...
                    echo "</span>
                        ...
                        ";
                    // line 231
                    $context["product_subs"] = (($__internal_compile_34 = ($context["subscriptions"] ?? null)) && is_array($__internal_compile_34) || $__internal_compile_34 instanceof ArrayAccess ? ($__internal_compile_34[twig_get_attribute($this->env, $this->source, $context["product"], "product_id", [], "any", false, false, false, 231)] ?? null) : null);
                    // line 232
                    echo "                        ";
                    if ( !twig_test_empty(($context["product_subs"] ?? null))) {
                        ...
                        foreach ($context['_seq'] as $context["_key"] => $context["subscription"]) {
                            ...
                            echo "                                <td class=\"text-center\">
                                    ";
                            // line 235
                            if ((twig_get_attribute($this->env, $this->source, $context["subscription"], "subs_type", [], "any", false, false, false, 235) == 1)) {
                                // line 236
                                echo "                                        Piso Per Day
                                    ";
                            } elseif ((twig_get_attribute($this->env, $this->source,                             // line 237
$context["subscription"], "subs_type", [], "any", false, false, false, 237) == 2)) {
                                // line 238
                                echo "                                        Piso Per Month
                                    ";
                            } else {
                            ...
                            echo "</td>
                                <td>";
                            // line 245
                            echo twig_get_attribute($this->env, $this->source, $context["subscription"], "date_expired", [], "any", false, false, false, 245);
                            echo "</td>
                            ";
                        }
                        $_parent = $context['_parent'];
