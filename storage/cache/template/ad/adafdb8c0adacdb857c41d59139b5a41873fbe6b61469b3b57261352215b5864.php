...
class __TwigTemplate_43aa548f70ab648908bacecd1aa97885870b8d5921edcd8e68de767a24faaf8d extends Template
{
    private $source;
    private $macros = [];
                  ...
                  <span class=\"text-success\">";
                    ...
                    if ( !twig_test_empty(($context["product_subs"] ?? null))) {
                        ...
                        foreach ($context['_seq'] as $context["_key"] => $context["subscription"]) {
                            // line 233
                            echo "                            <td>";
                            echo twig_get_attribute($this->env, $this->source, $context["subscription"], "duration", [], "any", false, false, false, 233);
                            echo " Days</td>
                          ";
                        }
                        $_parent = $context['_parent'];
