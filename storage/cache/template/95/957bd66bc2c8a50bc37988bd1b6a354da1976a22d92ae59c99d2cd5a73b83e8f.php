...
/* __string_template__1ee03a9ad49cd4a75273a9580b14e2b8ab4447a149157d379049c47487ce60ec */
class __TwigTemplate_967dcb6acc37d152e1b0270c7c3c5cca95bc0477ba971afd7223347df2c3d9ba extends Template
{
    private $source;
    private $macros = [];
...
document.addEventListener('DOMContentLoaded', function () {
    // Delegate event handler to dynamically added links
    document.querySelectorAll('.pagination-container a').forEach(link => {
        link.addEventListener('click', function (e) {
            ...
            fetch(url)
                ...
                .then(html => {
                    // Replace only the review container with the new HTML
                    const parser = new DOMParser();
                    const doc = parser.parseFromString(html, 'text/html');
                    const newContent = doc.querySelector('#review-container');

                    if (newContent) {
                        document.querySelector('#review-container').innerHTML = newContent.innerHTML;
                    }
                });
        });
    });
...
";
    ...
    {
        return "__string_template__1ee03a9ad49cd4a75273a9580b14e2b8ab4447a149157d379049c47487ce60ec";
    }
    ...
    {
        return array (  164 => 55,  158 => 53,  151 => 50,  144 => 48,  141 => 47,  131 => 43,  126 => 40,  123 => 39,  117 => 38,  111 => 34,  105 => 33,  101 => 31,  97 => 29,  94 => 28,  90 => 27,  83 => 23,  79 => 21,  76 => 20,  71 => 19,  69 => 18,  62 => 14,  57 => 12,  52 => 9,  47 => 8,  45 => 7,  37 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("", "__string_template__1ee03a9ad49cd4a75273a9580b14e2b8ab4447a149157d379049c47487ce60ec", "");
    }
}
