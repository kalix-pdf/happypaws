...
/* __string_template__7e666cf3471b1b7042b700d71832e0def84c0906ac183db3bd5a0ce10563ea88 */
class __TwigTemplate_0392a7e87e8c37e6545674e5201efeb2d17e9d093c1ead3224003d80e4e6dd76 extends Template
{
    private $source;
    private $macros = [];
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["option"]) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["option_value"]) {
                ...
                echo "\"
                        data-popup=\"";
                // line 399
                echo twig_get_attribute($this->env, $this->source, $context["option_value"], "popup", [], "any", false, false, false, 399);
                echo "\"
                        data-price=\"";
                // line 400
                echo twig_get_attribute($this->env, $this->source, $context["option_value"], "price", [], "any", false, false, false, 400);
                echo "\">
                        <img src=\"";
                // line 401
                echo twig_get_attribute($this->env, $this->source, $context["option_value"], "image", [], "any", false, false, false, 401);
                echo "\" class=\"card-img-top\" style=\"height: 50px; object-fit: contain;\">
                        <p class=\"card-text small\">";
                // line 402
                echo twig_get_attribute($this->env, $this->source, $context["option_value"], "name", [], "any", false, false, false, 402);
                echo "</p>
                        ";
                // line 404
                echo "                      </div>
...
";
    ...
    {
        return "__string_template__7e666cf3471b1b7042b700d71832e0def84c0906ac183db3bd5a0ce10563ea88";
    }
