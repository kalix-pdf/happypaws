...
class __TwigTemplate_7fe8ce064a9d71825f48311dd72c6ccd55dc50b79ac50d109b7fcd72a51e32e6 extends Template
{
    private $source;
    private $macros = [];
...
$context["product"]) && is_array($__internal_compile_16) || $__internal_compile_16 instanceof ArrayAccess ? ($__internal_compile_16["quantity"] ?? null) : null) <= ($context["low_stock_quantity"] ?? null))) {
                ...
                if ((($__internal_compile_19 = $context["product"]) && is_array($__internal_compile_19) || $__internal_compile_19 instanceof ArrayAccess ? ($__internal_compile_19["status"] ?? null) : null)) {
                    ...
                    // line 249
                    echo "                       <a data-toggle=\"tooltip\" title=\"Approve\" class=\"btn btn-warning cp-pro-status\" cp-pro-id=\"";
                ...
                echo "                    </td>
                      ";
                // line 257
                $context["product_subs"] = (($__internal_compile_22 = ($context["subscriptions"] ?? null)) && is_array($__internal_compile_22) || $__internal_compile_22 instanceof ArrayAccess ? ($__internal_compile_22[twig_get_attribute($this->env, $this->source, $context["product"], "product_id", [], "any", false, false, false, 257)] ?? null) : null);
                // line 258
                echo "                      ";
                $context['_parent'] = $context;
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["subscription"]) {
                    echo "                    
                      <td class=\"text-center\">
                        ";
                    // line 260
                    if ((twig_get_attribute($this->env, $this->source, $context["subscription"], "subs_type", [], "any", false, false, false, 260) == 1)) {
                        // line 261
                        echo "                          Piso Per Day
                        ";
                    } elseif ((twig_get_attribute($this->env, $this->source,                     // line 262
$context["subscription"], "subs_type", [], "any", false, false, false, 262) == 2)) {
                        // line 263
                        echo "                          Piso Per Month
                        ";
                    } else {
                    ...
                    echo "                      </td>
                      <td class=\"text-center\">";
                    // line 268
                    echo twig_get_attribute($this->env, $this->source, $context["subscription"], "date_added", [], "any", false, false, false, 268);
                    echo "</td>
                      ";
                    // line 269
                    if ((twig_get_attribute($this->env, $this->source, $context["subscription"], "subs_type", [], "any", false, false, false, 269) == 3)) {
                        // line 270
                        echo "                        <td class=\"text-center\">";
                        echo twig_get_attribute($this->env, $this->source, $context["subscription"], "duration", [], "any", false, false, false, 270);
                        echo "% commission</td>
                      ";
                    } else {
                        // line 272
                        echo "                        <td class=\"text-center\">";
                        echo twig_get_attribute($this->env, $this->source, $context["subscription"], "duration", [], "any", false, false, false, 272);
                        echo " days</td>
                      ";
                    }
                    // line 274
                    echo "                      <td class=\"text-center\">";
                    echo twig_get_attribute($this->env, $this->source, $context["subscription"], "date_expired", [], "any", false, false, false, 274);
                    echo "</td>
                    ";
                }
                $_parent = $context['_parent'];
