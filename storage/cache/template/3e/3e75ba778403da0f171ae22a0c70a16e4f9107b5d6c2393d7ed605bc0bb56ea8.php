...
/* __string_template__57ed28cb2372136752193a55d94aeb015ea08406ec5ff02869f7ae2401770e94 */
class __TwigTemplate_6acafda15bb7a380bdc11ce4bb23a657d3b6e41d6786761ccb72cfa35a6cbc61 extends Template
{
    private $source;
    private $macros = [];
      ...
      ";
        ...
        <div class=\"tab-pane fade show\" id=\"tab-to-cancel\">
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["order"]) {
                // line 555
                echo "              ";
                if ((twig_get_attribute($this->env, $this->source, $context["order"], "status", [], "any", false, false, false, 555) == "Canceled")) {
                    // line 556
                ...
                <div class=\"table-responsive container mb-4\">
                  <table class=\"table table-bordered table-light\">
                    ...
                    <tbody>
                      ";
                    // line 568
                    $context["product_list"] = (((twig_get_attribute($this->env, $this->source, ($context["product_info"] ?? null), twig_get_attribute($this->env, $this->source, $context["order"], "order_id", [], "any", false, false, false, 568), [], "array", true, true, false, 568) &&  !(null === (($__internal_compile_16 = ($context["product_info"] ?? null)) && is_array($__internal_compile_16) || $__internal_compile_16 instanceof ArrayAccess ? ($__internal_compile_16[twig_get_attribute($this->env, $this->source, $context["order"], "order_id", [], "any", false, false, false, 568)] ?? null) : null)))) ? ((($__internal_compile_17 = ($context["product_info"] ?? null)) && is_array($__internal_compile_17) || $__internal_compile_17 instanceof ArrayAccess ? ($__internal_compile_17[twig_get_attribute($this->env, $this->source, $context["order"], "order_id", [], "any", false, false, false, 568)] ?? null) : null)) : ([]));
                    // line 569
                    echo "                      ";
                    $context['_parent'] = $context;
                    $context['_seq'] = twig_ensure_traversable(($context["product_list"] ?? null));
                    foreach ($context['_seq'] as $context["_key"] => $context["prod"]) {
                        ...
                        echo "                        <tr>
                          <td style=\"width: 250px;\" class=\"text-center align-center\">
                            <img src=\"";
                        // line 572
                        echo twig_get_attribute($this->env, $this->source, $context["prod"], "image", [], "any", false, false, false, 572);
                        echo "\" alt=\"";
                        echo twig_get_attribute($this->env, $this->source, $context["prod"], "name", [], "any", false, false, false, 572);
                        echo "\" style=\"max-width: 120px; height: auto;\" class=\"img-fluid rounded\">
                          </td>
                          <td class=\"text-left\">";
                        // line 574
                        echo twig_get_attribute($this->env, $this->source, $context["prod"], "name", [], "any", false, false, false, 574);
                        echo "</td>
                          <td class=\"text-center\">";
                        // line 575
                        echo twig_get_attribute($this->env, $this->source, $context["prod"], "quantity", [], "any", false, false, false, 575);
                        echo "</td>
                          <td class=\"text-left\">";
                        // line 576
                        echo twig_get_attribute($this->env, $this->source, $context["order"], "status", [], "any", false, false, false, 576);
                        echo "</td>
                        </tr>
                      <tr>
                        <td class=\"text-left\"><strong>Payment Method:</strong></td>
                        ";
                        // line 580
                        if ((twig_get_attribute($this->env, $this->source, $context["order"], "payment_method", [], "any", false, false, false, 580) == "hitpay")) {
                            // line 581
                        ...
                        ";
                            ...
                            // line 583
                            echo "                          <td colspan=\"3\">";
                            echo twig_get_attribute($this->env, $this->source, $context["order"], "payment_method", [], "any", false, false, false, 583);
                            echo "</td>
                        ";
                        }
                        // line 585
                      ...
                      <tr>
                        ...
                        // line 588
                        echo twig_get_attribute($this->env, $this->source, $context["prod"], "seller_id", [], "any", false, false, false, 588);
                        echo "\">";
                        echo twig_get_attribute($this->env, $this->source, $context["prod"], "store", [], "any", false, false, false, 588);
                        echo " Shop</a></td>
                      </tr>
                    </tbody>
                    ";
...
\$(document).ready(function() {
    ...
    {
        return "__string_template__57ed28cb2372136752193a55d94aeb015ea08406ec5ff02869f7ae2401770e94";
    }
