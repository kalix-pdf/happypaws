...
/* __string_template__811d51b65cbdca1b17f9672d9abc17affe14c98d5f6499b1ca0fe3cb72aa6217 */
class __TwigTemplate_a2732db26265d5e8dbf3654a447f97db883d6013a5ba39dfbc6d20208e8bfed1 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t";
        ...
        if ((array_key_exists("public_seller_profile", $context) && twig_in_filter("review", ($context["public_seller_profile"] ?? null)))) {
            // line 350
            echo "\t\t\t\t\t<div class=\"tab-pane fade\" id=\"tab-reviews\" role=\"tabpanel\">kl
\t\t\t\t\t<p class=\"wk-mp-tab-content-text\">
\t\t\t\t\t\thajhaj";
            // line 352
            echo (((($context["text_reviews"] ?? null) . " (") . ((($context["feedback_total"] ?? null)) ? (($context["feedback_total"] ?? null)) : ("0"))) . ")");
            echo "
\t\t\t\t\t</p>
\t\t\t\t\t<div class=\"category-grid no-scroll-prev\">lll
...
";
    ...
    {
        return "__string_template__811d51b65cbdca1b17f9672d9abc17affe14c98d5f6499b1ca0fe3cb72aa6217";
    }
    ...
    {
        return new Source("", "__string_template__811d51b65cbdca1b17f9672d9abc17affe14c98d5f6499b1ca0fe3cb72aa6217", "");
    }
}
