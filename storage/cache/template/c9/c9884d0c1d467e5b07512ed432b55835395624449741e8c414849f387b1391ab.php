...
/* __string_template__7d47e6c0620323b67c490b595d02253ec020872344b429199a92cda26111008a */
class __TwigTemplate_e8527ce842ff0616b760769abe64ea9be1c2c1d40ccb5e405cb61bb8aec72bcc extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t";
            ...
            if ((twig_get_attribute($this->env, $this->source, ($context["partner"] ?? null), "thumb", [], "array", true, true, false, 48) && (($__internal_compile_2 = ($context["partner"] ?? null)) && is_array($__internal_compile_2) || $__internal_compile_2 instanceof ArrayAccess ? ($__internal_compile_2["thumb"] ?? null) : null))) {
                ...
                echo "\" class=\"image-seller img-fluid\" style=\"height:100px;object-fit:content;\">
\t\t\t\t\t\t\t\t";
            }
            // line 51
            echo "\t\t\t\t\t\t\t</div>
...
";
    ...
    {
        return "__string_template__7d47e6c0620323b67c490b595d02253ec020872344b429199a92cda26111008a";
    }
    ...
    {
        return new Source("", "__string_template__7d47e6c0620323b67c490b595d02253ec020872344b429199a92cda26111008a", "");
    }
}
