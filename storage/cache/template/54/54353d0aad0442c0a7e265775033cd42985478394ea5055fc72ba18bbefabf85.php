...
/* __string_template__b2c632cdb1f0943b70d67845560dbe082bb47c672cbc90d668e105f97af33b5b */
class __TwigTemplate_b5d6bc254d55579efa3fe373f029cfdadc54e57b43fc869a8fbf53b19e4408d3 extends Template
{
    private $source;
    private $macros = [];
        ...
        if (($context["options"] ?? null)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["option"]) {
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["option_value"]) {
                    ...
                    // line 198
                    echo (twig_get_attribute($this->env, $this->source, $context["option_value"], "name", [], "any", false, false, false, 198) + ($context["special"] ?? null));
                    echo "</p>
                        <p class=\"card-text small\">";
                    // line 199
...
";
    ...
    {
        return "__string_template__b2c632cdb1f0943b70d67845560dbe082bb47c672cbc90d668e105f97af33b5b";
    }
