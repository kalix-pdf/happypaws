...
/* __string_template__f47322dbab018a88ead315701bee24302a490980ba2d6c54c36d476b7389348d */
class __TwigTemplate_61b4ae0059c95f1391280177645a3b31fce861d2ec3248f9d370ff3745a3a36b extends Template
{
    private $source;
    private $macros = [];
        ...
        if (($context["options"] ?? null)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["option"]) {
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["option_value"]) {
                    // line 194
                    echo "                      ";
                    if ((twig_get_attribute($this->env, $this->source, $context["option_value"], "quantity", [], "any", false, false, false, 194) == 2)) {
                        // line 195
...
";
    ...
    {
        return "__string_template__f47322dbab018a88ead315701bee24302a490980ba2d6c54c36d476b7389348d";
    }
    ...
    {
        return new Source("", "__string_template__f47322dbab018a88ead315701bee24302a490980ba2d6c54c36d476b7389348d", "");
    }
}
