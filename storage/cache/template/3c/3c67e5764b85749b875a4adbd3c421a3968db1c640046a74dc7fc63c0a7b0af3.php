...
/* __string_template__e4666280e8d3497935a8c6ea4573ee29d847e210aef3361d533d50e7f6a55143 */
class __TwigTemplate_1bf9eef161fd8ee1f13d03f8e7b726bbdd66a3814af73ae1af281103d090d5dd extends Template
{
    private $source;
    private $macros = [];
...
\tthisvalue = this.href;
\t\$('a[href=\\'#tab-category\\']').append(' <i class=\"fa fa-spinner fa-spin remove-me\"></i>');
\t\$('#tab-collection').load(thisvalue,function(){
\t\t\$('.remove-me').remove();
\t\tif (localStorage.getItem('display') == 'list') {
\t\t\t\$('#list-view').trigger('click');
...
\t\t";
        } elseif ((($__internal_compile_13 =         // line 932
...
";
    ...
    {
        return "__string_template__e4666280e8d3497935a8c6ea4573ee29d847e210aef3361d533d50e7f6a55143";
    }
