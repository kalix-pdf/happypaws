...
/* __string_template__9a7140b73c3718cade540abbb8ef8a8f2f7351421988299d2047a405dcc2b1ce */
class __TwigTemplate_a649fd24b43b7a0ede6ec8d5203959d82147d9a60b0f4cba2b0c3b29cf9bff86 extends Template
{
    private $source;
    private $macros = [];
      ...
      <div class=\"tab-content\">
        <div class=\"tab-pane fade show\" id=\"tab-to-rate\">
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["order"]) {
                // line 312
                echo "              ";
                if ((twig_get_attribute($this->env, $this->source, $context["order"], "status", [], "any", false, false, false, 312) == "Processing")) {
                    // line 313
                    echo "              <div class=\"card my-4\">
                <div class=\"card-header\">
                  <div class=\"alert alert-info alert-dismissible\">
                  ...
                  <table class=\"table table-bordered table-light\">
                    ...
                    foreach ($context['_seq'] as $context["_key"] => $context["prod"]) {
                      ...
                      <tr class=\"text-right\">   
                        ...
                        // line 371
                        echo twig_get_attribute($this->env, $this->source, $context["prod"], "product_id", [], "any", false, false, false, 371);
                        echo "\" class=\"btn btn-primary text-right\">Rate</a>
                      </tr>
                      <tr class=\"text-right\">   
                        <a href=\"index.php?route=account/order/info&order_id=";
                        // line 374
                        echo twig_get_attribute($this->env, $this->source, $context["order"], "order_id", [], "any", false, false, false, 374);
...
\$(document).ready(function() {
    ...
    {
        return "__string_template__9a7140b73c3718cade540abbb8ef8a8f2f7351421988299d2047a405dcc2b1ce";
    }
