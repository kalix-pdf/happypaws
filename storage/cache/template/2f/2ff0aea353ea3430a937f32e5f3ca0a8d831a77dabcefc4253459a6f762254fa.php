...
class __TwigTemplate_b0edeb38c0a0f4b2f5fd1d71b96ad70c59a3851f7d84bbac2cc7dbf425248765 extends Template
{
    private $source;
    private $macros = [];
...
$context["subscription"], "subs_type", [], "any", false, false, false, 235) == 2)) {
                        ...
                        <td>";
                        // line 242
                        echo twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, $context["subscription"], "date_added", [], "any", false, false, false, 242), "Y-m-d");
                        echo "</td>
                        <td>";
                        // line 243
                        echo twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, $context["subscription"], "date_expired", [], "any", false, false, false, 243), "Y-m-d");
                        echo "</td>
                  ";
                    }
                    $_parent = $context['_parent'];
