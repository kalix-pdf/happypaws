...
/* __string_template__3a8dafcb45fdee354671f71b2aa4bc5a35a61cf6448c6fd5786b4274996fdfaf */
class __TwigTemplate_67f4ed275001ca52a3224219c99ed277ec0527807f6e91eaebb89ab3242ed008 extends Template
{
    private $source;
    private $macros = [];
...
<script type=\"text/javascript\">
  \$('#button-cart').on('click', function (e) {
    ...
    if (specialPrice) {
      summaryHtml += '<strong>Price:</strong> <span class=\"text-danger\">' + specialPrice + '</span><br><hr><br>';
    } else if (regularPrice) {
      summaryHtml += '<strong>Price:</strong> ' + regularPrice + '<br><hr><br>';
    }
...
";
    ...
    {
        return "__string_template__3a8dafcb45fdee354671f71b2aa4bc5a35a61cf6448c6fd5786b4274996fdfaf";
    }
    ...
    {
        return new Source("", "__string_template__3a8dafcb45fdee354671f71b2aa4bc5a35a61cf6448c6fd5786b4274996fdfaf", "");
    }
}
