...
/* __string_template__115c103ac8be13e57dc7a7295e02a23ce159cb7c35f7457a10fcaa05b7fd6664 */
class __TwigTemplate_b926b305f8dabc4031b2510b22ef98187bc0af9d6578f9bdf394f836deb5b3ed extends Template
{
    private $source;
    private $macros = [];
...
$context["order"], "status", [], "any", false, false, false, 229) == "Delivered") && (twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, $context["order"], "status", [], "any", false, false, false, 229)) > 0))) {
                ...
                <div class=\"table-responsive container mb-4\">
                  ...
                  ";
                    // line 297
                    if (((twig_get_attribute($this->env, $this->source, $context["order"], "status", [], "any", false, false, false, 297) == "Picked-up") || (twig_get_attribute($this->env, $this->source, $context["order"], "status", [], "any", false, false, false, 297) == "In Transit"))) {
                        // line 298
                    ...
                    // line 302
                    echo "                  ";
                    if ((twig_get_attribute($this->env, $this->source, $context["order"], "status", [], "any", false, false, false, 302) == "Delivered")) {
                        // line 303
                        echo "                    <div class=\"d-flex justify-content-end\">
                        <button id=\"RcvdOrderBtn\" data-tracking=\"";
                        // line 304
                        echo twig_get_attribute($this->env, $this->source, $context["order"], "order_id", [], "any", false, false, false, 304);
      ...
      ";
        ...
        <div class=\"tab-pane fade show\" id=\"tab-to-cancel\">
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["order"]) {
                // line 430
                echo "              ";
                if ((twig_get_attribute($this->env, $this->source, $context["order"], "status", [], "any", false, false, false, 430) == "Canceled")) {
                    // line 431
                    echo "              <div class=\"card my-4\">
                <div class=\"table-responsive container mb-4\">
                  <table class=\"table table-bordered table-light\">
                    ...
                    <tbody>
                      ";
                    // line 443
                    $context["product_list"] = (((twig_get_attribute($this->env, $this->source, ($context["product_info"] ?? null), twig_get_attribute($this->env, $this->source, $context["order"], "order_id", [], "any", false, false, false, 443), [], "array", true, true, false, 443) &&  !(null === (($__internal_compile_6 = ($context["product_info"] ?? null)) && is_array($__internal_compile_6) || $__internal_compile_6 instanceof ArrayAccess ? ($__internal_compile_6[twig_get_attribute($this->env, $this->source, $context["order"], "order_id", [], "any", false, false, false, 443)] ?? null) : null)))) ? ((($__internal_compile_7 = ($context["product_info"] ?? null)) && is_array($__internal_compile_7) || $__internal_compile_7 instanceof ArrayAccess ? ($__internal_compile_7[twig_get_attribute($this->env, $this->source, $context["order"], "order_id", [], "any", false, false, false, 443)] ?? null) : null)) : ([]));
                    // line 444
                    echo "                      ";
                    $context['_parent'] = $context;
                    $context['_seq'] = twig_ensure_traversable(($context["product_list"] ?? null));
                    foreach ($context['_seq'] as $context["_key"] => $context["prod"]) {
                        ...
                        echo "                        <tr>
                          <td style=\"width: 250px;\" class=\"text-center align-center\">
                            <img src=\"";
                        // line 447
                        echo twig_get_attribute($this->env, $this->source, $context["prod"], "image", [], "any", false, false, false, 447);
                        echo "\" alt=\"";
                        echo twig_get_attribute($this->env, $this->source, $context["prod"], "name", [], "any", false, false, false, 447);
                        echo "\" style=\"max-width: 120px; height: auto;\" class=\"img-fluid rounded\">
                          </td>
                          <td class=\"text-left\">";
                        // line 449
                        echo twig_get_attribute($this->env, $this->source, $context["prod"], "name", [], "any", false, false, false, 449);
                        echo "</td>
                          <td class=\"text-center\">";
                        // line 450
                        echo twig_get_attribute($this->env, $this->source, $context["prod"], "quantity", [], "any", false, false, false, 450);
                        echo "</td>
                          <td class=\"text-left\">";
                        // line 451
                        echo twig_get_attribute($this->env, $this->source, $context["order"], "status", [], "any", false, false, false, 451);
                        echo "</td>
                        </tr>
                      <tr>
                        <td class=\"text-left\"><strong>Payment Method:</strong></td>
                        ";
                        // line 455
                        if ((twig_get_attribute($this->env, $this->source, $context["order"], "payment_method", [], "any", false, false, false, 455) == "hitpay")) {
                            // line 456
                            echo "                          <td colspan=\"3\">Online Payment</td>
                        ";
                        } else {
                            // line 458
                            echo "                          <td colspan=\"3\">";
                            echo twig_get_attribute($this->env, $this->source, $context["order"], "payment_method", [], "any", false, false, false, 458);
                            echo "</td>
                        ";
                        }
                        // line 460
                      ...
                      <tr>
                        ...
                        <td colspan=\"3\"><a class=\"text-decoration-none\" href=\"index.php?route=customerpartner/profile&seller_id=";
                        // line 463
                        echo twig_get_attribute($this->env, $this->source, $context["prod"], "seller_id", [], "any", false, false, false, 463);
                        echo "\">";
                        echo twig_get_attribute($this->env, $this->source, $context["prod"], "store", [], "any", false, false, false, 463);
                        echo " Shop</a></td>
                      </tr>
                    </tbody>
                    ";
...
\$(document).ready(function() {
    ...
    {
        return "__string_template__115c103ac8be13e57dc7a7295e02a23ce159cb7c35f7457a10fcaa05b7fd6664";
    }
    ...
    {
        return array (  823 => 589,  756 => 482,  750 => 479,  746 => 477,  742 => 475,  737 => 472,  731 => 471,  725 => 467,  713 => 463,  708 => 460,  702 => 458,  698 => 456,  696 => 455,  689 => 451,  685 => 450,  681 => 449,  674 => 447,  670 => 445,  665 => 444,  663 => 443,  649 => 431,  646 => 430,  642 => 429,  638 => 427,  633 => 314,  627 => 313,  622 => 310,  616 => 307,  610 => 304,  607 => 303,  604 => 302,  598 => 299,  595 => 298,  593 => 297,  590 => 296,  578 => 292,  574 => 290,  568 => 287,  564 => 285,  562 => 284,  557 => 282,  552 => 279,  546 => 277,  542 => 275,  540 => 274,  532 => 269,  522 => 262,  513 => 256,  509 => 255,  503 => 254,  496 => 252,  492 => 250,  487 => 249,  485 => 248,  471 => 236,  466 => 233,  461 => 230,  459 => 229,  455 => 227,  453 => 226,  449 => 224,  447 => 223,  443 => 221,  440 => 220,  436 => 219,  430 => 215,  424 => 214,  416 => 209,  412 => 207,  400 => 203,  396 => 201,  390 => 198,  386 => 196,  384 => 195,  379 => 193,  374 => 190,  368 => 188,  364 => 186,  362 => 185,  354 => 180,  344 => 173,  335 => 167,  331 => 166,  325 => 165,  318 => 163,  314 => 161,  309 => 160,  307 => 159,  288 => 142,  285 => 141,  281 => 140,  275 => 136,  269 => 135,  260 => 129,  256 => 127,  244 => 123,  240 => 121,  234 => 118,  230 => 116,  228 => 115,  223 => 113,  218 => 110,  212 => 108,  208 => 106,  206 => 105,  199 => 101,  195 => 100,  189 => 99,  182 => 97,  178 => 95,  173 => 94,  171 => 93,  152 => 76,  149 => 75,  145 => 74,  121 => 52,  119 => 51,  111 => 49,  108 => 48,  105 => 47,  102 => 46,  99 => 45,  97 => 44,  93 => 42,  89 => 37,  78 => 34,  75 => 33,  71 => 32,  37 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("", "__string_template__115c103ac8be13e57dc7a7295e02a23ce159cb7c35f7457a10fcaa05b7fd6664", "");
    }
}
