...
/* __string_template__dd3d5a0f87616940e3be4f541b1ba8439b3f0abd493aee79e99798d961b22686 */
class __TwigTemplate_f1fc0b9aa62c006e3e4a5d9c1bbb6ae76e427f1c22d562af06653e6cfa1b9d85 extends Template
{
    private $source;
    private $macros = [];
...
\$('.selectable-option').on('click', function () {
  ...
  const rawPrice = selectedOption.data('price');
  ...
  \$('.selectable-option.border-primary').each(function () {
    const price = cleanPrice(\$(this).data('price'));
    totalPrice += price;
  });

  if (!isNaN(totalPrice)) {
    \$('#special-price').text(formatPrice(priceDelta));
  } else {
    \$('#special-price').text('Invalid price');
  }
});
...
";
    ...
    {
        return "__string_template__dd3d5a0f87616940e3be4f541b1ba8439b3f0abd493aee79e99798d961b22686";
    }
