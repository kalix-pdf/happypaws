...
class __TwigTemplate_5834e30357c6ff06125357fd13f0116909fd84fef12402d133b9b5aca653b616 extends Template
{
    private $source;
    private $macros = [];
...
<script>
  document.getElementById('subs').addEventListener('change', function () {
    ...
    document.querySelectorAll('.subscription-section').forEach(el => {
      el.style.display = 'none';
      
      el.querySelectorAll('input, select').forEach(input => input.value = '');
    });
