...
/* __string_template__c726f1d91898727f7e5efa541b9e27779f7f0fa28dcc830291c5588c2268b5b1 */
class __TwigTemplate_9f5712f3e9432e691b08d81c3b7784716a2f8ff85b1251b3e1c37af9f4eb3074 extends Template
{
    private $source;
    private $macros = [];
        ...
        if (($context["tags"] ?? null)) {
          ...
          ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["i"]) {
                // line 258
                echo "            <a href=\"";
                echo twig_get_attribute($this->env, $this->source, (($__internal_compile_0 = ($context["tags"] ?? null)) && is_array($__internal_compile_0) || $__internal_compile_0 instanceof ArrayAccess ? ($__internal_compile_0[$context["i"]] ?? null) : null), "href", [], "any", false, false, false, 258);
                echo "\">";
                echo twig_get_attribute($this->env, $this->source, (($__internal_compile_1 = ($context["tags"] ?? null)) && is_array($__internal_compile_1) || $__internal_compile_1 instanceof ArrayAccess ? ($__internal_compile_1[$context["i"]] ?? null) : null), "tag", [], "any", false, false, false, 258);
                echo "</a>";
...
$context["i"] == (($context["full"] ?? null) + 1)) && ($context["half"] ?? null))) {
    ...
    ";
      ...
      ";
        // line 307
        $this->loadTemplate("product/review_list.twig", "__string_template__c726f1d91898727f7e5efa541b9e27779f7f0fa28dcc830291c5588c2268b5b1", 307)->display($context);
        // line 308
        echo "    </div>
  </div>
...
document.addEventListener('click', function (e) {
  if (e.target.tagName === 'A' && e.target.closest('#review-list')) {
    const url = e.target.getAttribute('href');
    if (url && url.includes('product/product/ajaxReviews')) {
      e.preventDefault();
      ...
      fetch(url)
        ...
        .then(html => {
          ...
          window.scrollTo({ top: document.getElementById('review-list').offsetTop - 100, behavior: 'smooth' });
        });
    }
  }
});
...
";
    ...
    {
        return "__string_template__c726f1d91898727f7e5efa541b9e27779f7f0fa28dcc830291c5588c2268b5b1";
    }
