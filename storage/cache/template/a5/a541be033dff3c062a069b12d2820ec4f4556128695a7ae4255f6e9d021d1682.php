...
/* __string_template__dd05961e981fafda8415cc47027478eb92c871939ef27390e0b2eb1a543b3a7c */
class __TwigTemplate_230b6ca5eada0fad6ab2f65c04836763ebfb84b368b5eda0a848feb1b4515d5d extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"modal-dialog\" role=\"document\">
      <div class=\"modal-content rounded-3\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["option"]) {
            ...
            // line 391
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, $context["option"], "product_option_value", [], "any", false, false, false, 391));
            foreach ($context['_seq'] as $context["_key"] => $context["option_value"]) {
                // line 392
                echo "                      <div class=\"card selectable-option text-center\" style=\"width: 70px; cursor: pointer;\"
                        data-option-id=\"";
                ...
                echo "\"
                        data-option-value-id=\"";
                // line 394
                echo twig_get_attribute($this->env, $this->source, $context["option_value"], "product_option_value_id", [], "any", false, false, false, 394);
                echo "\"
                        data-option-name=\"";
                // line 395
                echo twig_get_attribute($this->env, $this->source, $context["option_value"], "name", [], "any", false, false, false, 395);
                echo "\"
                        data-popup=\"";
                // line 396
                echo twig_get_attribute($this->env, $this->source, $context["option_value"], "popup", [], "any", false, false, false, 396);
                echo "\"
                        data-price=\"";
                // line 397
                echo twig_get_attribute($this->env, $this->source, $context["option_value"], "price", [], "any", false, false, false, 397);
                echo "\">
                        <img src=\"";
                // line 398
...
\$('#button-cart').on('click', function (e) {
  ...
  // Optional: show selected options/price summary
  var productName = \$('#content h1').text(); // Or another selector
  ...
  if (specialPrice) {
    summaryHtml += '<strong>Price:</strong> <span class=\"text-danger\">' + specialPrice + '</span>';
  } else if (regularPrice) {
    summaryHtml += '<strong>Price:</strong> ' + regularPrice;
  }
...
";
    ...
    {
        return "__string_template__dd05961e981fafda8415cc47027478eb92c871939ef27390e0b2eb1a543b3a7c";
    }
