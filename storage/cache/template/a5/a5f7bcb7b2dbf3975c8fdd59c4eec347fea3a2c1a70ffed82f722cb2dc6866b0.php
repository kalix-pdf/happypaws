...
/* __string_template__7979477e5e98070745236fd7e17d01d8fc3e5f0b236c6abdafa8c25cd97eaf14 */
class __TwigTemplate_4ee82c3a9a7afb0a16073fe6789aef9fcb76e7e099510f2f116fd3a34918cfbe extends Template
{
    private $source;
    private $macros = [];
...
function addOptionValue(option_row) {
  ...
  html += '    <input type=\"text\" name=\"product_option[' + option_value_row + '][quantity]\" value=\"\" placeholder=\"";
        // line 2967
        echo ($context["entry_quantity"] ?? null);
        echo "\" class=\"form-control\" />';
  html += '  </td>';
  ...
  // Subtract select
  html += '  <td class=\"text-left\">';
  html += '    <select name=\"product_option[' + option_value_row + '][subtract]\" class=\"form-control\">';
  html += '      <option value=\"1\">";
        // line 2973
        echo ($context["text_yes"] ?? null);
        echo "</option>';
  ...
  // Price input
  html += '  <td class=\"text-right\">';
  html += '    <input type=\"text\" name=\"product_option[' + option_value_row + '][price]\" value=\"\" placeholder=\"";
        // line 2980
        echo ($context["entry_price"] ?? null);
        echo "\" class=\"form-control\" />';
  html += '  </td>';
  ...
  // Weight input
  html += '  <td class=\"text-right\">';
  html += '    <input type=\"text\" name=\"product_option[' + option_value_row + '][weight]\" value=\"\" placeholder=\"";
        // line 2985
        echo ($context["entry_weight"] ?? null);
        echo "\" class=\"form-control\" />';
  html += '  </td>';
...
";
    ...
    {
        return "__string_template__7979477e5e98070745236fd7e17d01d8fc3e5f0b236c6abdafa8c25cd97eaf14";
    }
    ...
    {
        return new Source("", "__string_template__7979477e5e98070745236fd7e17d01d8fc3e5f0b236c6abdafa8c25cd97eaf14", "");
    }
}
