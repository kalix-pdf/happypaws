...
/* __string_template__fa8e6f9cc281315b6222b44953946dccd13a8926f02621e577aeccdb9f0f7615 */
class __TwigTemplate_383e8324874c6aa7bf43276eb69a089ec31030f8633861c309506200b4d7c2bb extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t<label class=\"control-label\">";
                // line 380
                echo (($__internal_compile_7 = $context["review_field"]) && is_array($__internal_compile_7) || $__internal_compile_7 instanceof ArrayAccess ? ($__internal_compile_7["field_name"] ?? null) : null);
                echo "</label><br>
...
\t";
    ...
    // Load the content of the review wrapper only
    \$('#feedback-wrapper').load(uniqueUrl + ' #feedback-wrapper > *', function() {
        // Rebind pagination events after content is loaded
        bindPagination();
    });
});
...
";
    ...
    // Load the content of the review wrapper only
    \$('#product-review-wrapper').load(uniqueUrl + ' #product-review-wrapper > *', function() {
        // Rebind pagination events after content is loaded
        bindPagination();
    });
});

// Rebind the pagination click event
function bindPagination() {
    ...
    \$(document).on('click', '.pagination a', function(e) {
        ...
        // Load the content of the review wrapper only
        \$('#feedback-wrapper').load(uniqueUrl + ' #feedback-wrapper > *');
    });
    ...
    \$(document).on('click', '.pagination a', function(e) {
        ...
        // Load the content of the review wrapper only
        \$('#product-review-wrapper').load(uniqueUrl + ' #product-review-wrapper > *');
    });
}
...
\t\t";
        } elseif ((($__internal_compile_11 =         // line 1022
...
";
    ...
    {
        return "__string_template__fa8e6f9cc281315b6222b44953946dccd13a8926f02621e577aeccdb9f0f7615";
    }
    ...
    {
        return array (  1047 => 1031,  1041 => 1027,  1037 => 1025,  1031 => 1023,  1029 => 1022,  1023 => 1020,  1021 => 1019,  936 => 937,  916 => 919,  793 => 796,  774 => 780,  760 => 769,  755 => 766,  735 => 749,  731 => 748,  726 => 746,  718 => 741,  703 => 728,  701 => 727,  698 => 726,  694 => 717,  690 => 715,  688 => 714,  614 => 642,  598 => 627,  586 => 617,  497 => 531,  478 => 515,  468 => 507,  465 => 449,  453 => 440,  449 => 439,  438 => 431,  434 => 429,  428 => 427,  426 => 426,  421 => 424,  413 => 419,  408 => 417,  399 => 410,  397 => 409,  383 => 400,  379 => 399,  373 => 395,  370 => 394,  358 => 389,  346 => 385,  343 => 384,  339 => 383,  335 => 382,  330 => 380,  326 => 378,  321 => 377,  319 => 376,  314 => 373,  309 => 370,  296 => 360,  285 => 352,  278 => 347,  271 => 341,  268 => 339,  252 => 310,  245 => 306,  241 => 304,  238 => 303,  230 => 298,  226 => 296,  224 => 295,  221 => 294,  217 => 291,  207 => 284,  197 => 281,  193 => 280,  189 => 278,  186 => 277,  183 => 275,  173 => 267,  167 => 263,  165 => 262,  162 => 261,  160 => 260,  156 => 259,  151 => 256,  148 => 255,  143 => 251,  138 => 248,  124 => 46,  118 => 43,  114 => 42,  110 => 41,  107 => 40,  105 => 39,  89 => 25,  82 => 22,  79 => 21,  72 => 18,  70 => 17,  65 => 14,  58 => 11,  55 => 10,  49 => 7,  46 => 6,  44 => 5,  37 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("", "__string_template__fa8e6f9cc281315b6222b44953946dccd13a8926f02621e577aeccdb9f0f7615", "");
    }
}
