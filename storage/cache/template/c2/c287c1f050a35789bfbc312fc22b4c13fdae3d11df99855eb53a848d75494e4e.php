...
/* __string_template__00bdb91cb99f3f4fd4f12801b7161fe0f47df7afe96eb259e5367eeca2534f04 */
class __TwigTemplate_f012bd331f62da5507c1f0c57041b9463640ae666c5e6d4ad938a9dd56c45890 extends Template
{
    private $source;
    private $macros = [];
...
<div id=\"product-product\" class=\"container mb-5\">
  ...
  <div class=\"card my-4 px-5 py-4\">
    ";
        ...
        if (($context["review_status"] ?? null)) {
            // line 281
            echo "      <div class=\"mb-4 d-flex align-items-center gap-4 \">
      ...
      <div class=\"p-4 border border-info-subtle\">
        <h4><strong>";
            // line 286
        ...
        ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["i"]) {
                ...
                if (($context["i"] <= ($context["full"] ?? null))) {
                    // line 292
                    echo "              <i class=\"fa fa-paw text-warning\"></i>
            ";
                } elseif (((                // line 293
$context["i"] == (($context["full"] ?? null) + 1)) && ($context["half"] ?? null))) {
                    // line 294
                    echo "              <i class=\"fa fa-paw text-secondary\" style=\"opacity: 0.5;\"></i>
            ";
                } else {
                    // line 296
...
";
    ...
    {
        return "__string_template__00bdb91cb99f3f4fd4f12801b7161fe0f47df7afe96eb259e5367eeca2534f04";
    }
