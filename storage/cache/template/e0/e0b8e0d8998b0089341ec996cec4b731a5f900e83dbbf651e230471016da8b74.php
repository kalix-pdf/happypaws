...
class __TwigTemplate_eb4537d8269ecbd6fd7871ae0ebb8c35f6fe039a0a04397e1e28ec6b78f827d4 extends Template
{
    private $source;
    private $macros = [];
            ...
            if ( !twig_test_empty(($context["product_subs"] ?? null))) {
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["subscription"]) {
                    ...
                    echo "</td>
                            ...
                            ";
                    // line 153
                    if ((twig_get_attribute($this->env, $this->source, $context["subscription"], "subs_type", [], "any", false, false, false, 153) == 2)) {
                        // line 154
