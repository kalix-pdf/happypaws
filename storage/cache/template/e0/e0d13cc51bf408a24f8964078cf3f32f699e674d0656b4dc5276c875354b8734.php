...
/* __string_template__3837b9b3c0a36768e9d8385ff5ae47ff8f4776dbde49d35cbabf00a5e2ad3e39 */
class __TwigTemplate_d096fcf223dc82476e635aac8d0ccffa76fe0e3c0a4e3bdcd13107a4543d0d47 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t";
            ...
            if ((twig_get_attribute($this->env, $this->source, ($context["partner"] ?? null), "thumb", [], "array", true, true, false, 48) && (($__internal_compile_2 = ($context["partner"] ?? null)) && is_array($__internal_compile_2) || $__internal_compile_2 instanceof ArrayAccess ? ($__internal_compile_2["thumb"] ?? null) : null))) {
                ...
                echo "\" class=\"img-fluid\" style=\"height:100px;object-fit:content;\">
\t\t\t\t\t\t\t\t";
            }
            // line 51
            echo "\t\t\t\t\t\t\t</div>
...
";
    ...
    {
        return "__string_template__3837b9b3c0a36768e9d8385ff5ae47ff8f4776dbde49d35cbabf00a5e2ad3e39";
    }
    ...
    {
        return new Source("", "__string_template__3837b9b3c0a36768e9d8385ff5ae47ff8f4776dbde49d35cbabf00a5e2ad3e39", "");
    }
}
