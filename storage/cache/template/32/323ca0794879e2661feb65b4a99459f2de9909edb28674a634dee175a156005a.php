...
/* __string_template__e1dd1669e7bad758583ab4fd754bb784bcb56274028b582d229c7dccd29bfb91 */
class __TwigTemplate_22fe167c9cacefa1d60b33aee5a05962cb179b956cc2e787d9b6b193f7963523 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t<div class=\"rating-container fs-3\">
\t\t\t\t\t\t\t\t";
                            // line 27
                            $context['_parent'] = $context;
                            ...
                            foreach ($context['_seq'] as $context["_key"] => $context["i"]) {
                                ...
                                if (($context["i"] < (($__internal_compile_4 = (($__internal_compile_5 = $context["feedback"]) && is_array($__internal_compile_5) || $__internal_compile_5 instanceof ArrayAccess ? ($__internal_compile_5["review_attributes"] ?? null) : null)) && is_array($__internal_compile_4) || $__internal_compile_4 instanceof ArrayAccess ? ($__internal_compile_4[(($__internal_compile_6 = $context["review_field"]) && is_array($__internal_compile_6) || $__internal_compile_6 instanceof ArrayAccess ? ($__internal_compile_6["field_id"] ?? null) : null)] ?? null) : null))) {
                                    // line 29
                                    echo "\t\t\t\t\t\t\t\t\t\t<span class=\"fa fa-stack\"><i class=\"fa fa-paw text-warning\"></i></span>
\t\t\t\t\t\t\t\t\t";
                                } else {
                                    // line 31
...
\t";
    ...
    {
        return "__string_template__e1dd1669e7bad758583ab4fd754bb784bcb56274028b582d229c7dccd29bfb91";
    }
    ...
    {
        return new Source("", "__string_template__e1dd1669e7bad758583ab4fd754bb784bcb56274028b582d229c7dccd29bfb91", "");
    }
}
