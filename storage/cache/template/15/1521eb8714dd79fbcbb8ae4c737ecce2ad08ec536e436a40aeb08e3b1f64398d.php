...
/* __string_template__3170d3fd4550a879783c3517049a49e42d65398c064209ca6460df8b203db0d3 */
class __TwigTemplate_43af9c34706bf440931f00a4ebc665bf9e926d383906d436f75380c78266dded extends Template
{
    private $source;
    private $macros = [];
...
\t\$(document).on('click', '.pagination a', function(e) {
    ...
    // Append a timestamp to avoid caching issues (cache busting)
    const separator = url.includes('?') ? '&' : '?';
    const uniqueUrl = url + separator + 't=' + new Date().getTime();

    // Load the content from the new URL and update only the feedback section
...
\t\t";
        } elseif ((($__internal_compile_14 =         // line 979
...
";
    ...
    {
        return "__string_template__3170d3fd4550a879783c3517049a49e42d65398c064209ca6460df8b203db0d3";
    }
