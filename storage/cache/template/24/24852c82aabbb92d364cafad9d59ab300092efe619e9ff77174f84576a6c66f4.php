...
/* __string_template__f8f06e551c2e66cea449e843568497cae13dc3c453f2ab5d93da7dfe05b0f2bf */
class __TwigTemplate_d01db58db7975652d773c535e9abc200c46c01bc42959046591a6a3fd1043fdc extends Template
{
    private $source;
    private $macros = [];
...
\t";
        // line 627
        echo "\t\$(document).on('click', '.pagination-wrapper-feedback a', function(e) {
\t\te.preventDefault();
\t\t
...
\t";
        // line 639
        echo "\t\$(document).on('click', '.pagination-wrapper a', function(e) {
\t\te.preventDefault();
\t\t
\t\tconst url = \$(this).attr('href');
...
\t\t";
        } elseif ((($__internal_compile_11 =         // line 988
...
";
    ...
    {
        return "__string_template__f8f06e551c2e66cea449e843568497cae13dc3c453f2ab5d93da7dfe05b0f2bf";
    }
