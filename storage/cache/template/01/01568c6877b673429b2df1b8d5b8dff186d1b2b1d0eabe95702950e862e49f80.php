...
/* __string_template__b9a4cf809f2938a643a73df5fd189b3fe641d2b6c4fcab3ea0eb1747eb575bf5 */
class __TwigTemplate_2f6c12333e703755d914f23c25bc5e30e17e3317cc0cdb47223ab5f9dfa1a26c extends Template
{
    private $source;
    private $macros = [];
...
<div id=\"account-account\" class=\"container\">
  ...
  <div class=\"row\">";
    ...
    ";
      ...
      <div class=\"tab-content\">
        <div class=\"tab-pane fade show active\" id=\"tab-to-ship\">
            ";
            // line 142
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable(($context["orders"] ?? null));
            foreach ($context['_seq'] as $context["_key"] => $context["order"]) {
                ...
                <div class=\"table-responsive container mb-4\">
                  <table class=\"table table-bordered table-light\">
                    ...
                    foreach ($context['_seq'] as $context["_key"] => $context["prod"]) {
                      ...
                      <tr>
                        ...
                        ";
                        // line 178
                        if ((twig_get_attribute($this->env, $this->source, $context["order"], "payment_method", [], "any", false, false, false, 178) == "hitpay")) {
                            // line 179
                            echo "                          <td colspan=\"3\">Online Payment</td>
                        ";
                        } else {
                            // line 181
                            echo "                          <td colspan=\"3\">";
                            echo twig_get_attribute($this->env, $this->source, $context["order"], "payment_method", [], "any", false, false, false, 181);
                            echo "</td>
                        ";
                        }
                        // line 183
                      ...
                      <tr>
                        ...
                        <td colspan=\"3\">";
                        // line 186
                        echo twig_get_attribute($this->env, $this->source, $context["order"], "payment_status", [], "any", false, false, false, 186);
                        echo "</td>
                      </tr>
                      ";
                        // line 188
                        if (twig_get_attribute($this->env, $this->source, $context["order"], "payment_url", [], "any", false, false, false, 188)) {
                            // line 189
                            echo "                      <tr class=\"table-danger\">
                        <td><strong>Payment Link:</strong></td>
                        <td colspan=\"3\"><a class=\"text-decoration-none btn btn-primary\" href=\"";
                            // line 191
                            echo twig_get_attribute($this->env, $this->source, $context["order"], "payment_url", [], "any", false, false, false, 191);
                            echo "\">Pay Order<a></td>
                      </tr>
                      ";
                        }
                  ...
                  <div class=\"d-flex justify-content-end\">
                    ...
                    // line 202
                    echo twig_get_attribute($this->env, $this->source, $context["order"], "tracking", [], "any", false, false, false, 202);
      ...
      ";
        ...
        <div class=\"tab-pane fade show\" id=\"tab-to-cancel\">
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["order"]) {
                // line 371
                echo "              ";
                if ((twig_get_attribute($this->env, $this->source, $context["order"], "status", [], "any", false, false, false, 371) == "Canceled")) {
                    // line 372
                    echo "              <div class=\"card my-4\">
                <div class=\"table-responsive container mb-4\">
                  <table class=\"table table-bordered table-light\">
                    ...
                    <tbody>
                      ";
                    // line 384
                    $context["product_list"] = (((twig_get_attribute($this->env, $this->source, ($context["product_info"] ?? null), twig_get_attribute($this->env, $this->source, $context["order"], "order_id", [], "any", false, false, false, 384), [], "array", true, true, false, 384) &&  !(null === (($__internal_compile_4 = ($context["product_info"] ?? null)) && is_array($__internal_compile_4) || $__internal_compile_4 instanceof ArrayAccess ? ($__internal_compile_4[twig_get_attribute($this->env, $this->source, $context["order"], "order_id", [], "any", false, false, false, 384)] ?? null) : null)))) ? ((($__internal_compile_5 = ($context["product_info"] ?? null)) && is_array($__internal_compile_5) || $__internal_compile_5 instanceof ArrayAccess ? ($__internal_compile_5[twig_get_attribute($this->env, $this->source, $context["order"], "order_id", [], "any", false, false, false, 384)] ?? null) : null)) : ([]));
                    // line 385
                    echo "                      ";
                    $context['_parent'] = $context;
                    $context['_seq'] = twig_ensure_traversable(($context["product_list"] ?? null));
                    foreach ($context['_seq'] as $context["_key"] => $context["prod"]) {
                        ...
                        echo "                        <tr>
                          <td style=\"width: 250px;\" class=\"text-center align-center\">
                            <img src=\"";
                        // line 388
                        echo twig_get_attribute($this->env, $this->source, $context["prod"], "image", [], "any", false, false, false, 388);
                        echo "\" alt=\"";
                        echo twig_get_attribute($this->env, $this->source, $context["prod"], "name", [], "any", false, false, false, 388);
                        echo "\" style=\"max-width: 120px; height: auto;\" class=\"img-fluid rounded\">
                          </td>
                          <td class=\"text-left\">";
                        // line 390
                        echo twig_get_attribute($this->env, $this->source, $context["prod"], "name", [], "any", false, false, false, 390);
                        echo "</td>
                          <td class=\"text-center\">";
                        // line 391
                        echo twig_get_attribute($this->env, $this->source, $context["prod"], "quantity", [], "any", false, false, false, 391);
                        echo "</td>
                          <td class=\"text-left\">";
                        // line 392
                        echo twig_get_attribute($this->env, $this->source, $context["order"], "status", [], "any", false, false, false, 392);
                        echo "</td>
                        </tr>
                      <tr>
                        <td class=\"text-left\"><strong>Payment Method:</strong></td>
                        ";
                        // line 396
                        if ((twig_get_attribute($this->env, $this->source, $context["order"], "payment_method", [], "any", false, false, false, 396) == "hitpay")) {
                            // line 397
                            echo "                          <td colspan=\"3\">Online Payment</td>
                        ";
                        } else {
                            // line 399
                            echo "                          <td colspan=\"3\">";
                            echo twig_get_attribute($this->env, $this->source, $context["order"], "payment_method", [], "any", false, false, false, 399);
                            echo "</td>
                        ";
                        }
                        // line 401
                      ...
                      <tr>
                        ...
                        <td colspan=\"3\"><a class=\"text-decoration-none\" href=\"index.php?route=customerpartner/profile&seller_id=";
                        // line 404
                        echo twig_get_attribute($this->env, $this->source, $context["prod"], "seller_id", [], "any", false, false, false, 404);
                        echo "\">";
                        echo twig_get_attribute($this->env, $this->source, $context["prod"], "store", [], "any", false, false, false, 404);
                        echo " Shop</a></td>
                      </tr>
                    </tbody>
                    ";
...
\$(document).ready(function() {
    ...
    {
        return "__string_template__b9a4cf809f2938a643a73df5fd189b3fe641d2b6c4fcab3ea0eb1747eb575bf5";
    }
    ...
    {
        return array (  618 => 531,  551 => 424,  544 => 420,  541 => 419,  539 => 418,  535 => 416,  530 => 413,  524 => 412,  518 => 408,  506 => 404,  501 => 401,  495 => 399,  491 => 397,  489 => 396,  482 => 392,  478 => 391,  474 => 390,  467 => 388,  463 => 386,  458 => 385,  456 => 384,  442 => 372,  439 => 371,  435 => 370,  431 => 368,  427 => 208,  421 => 207,  413 => 202,  409 => 200,  397 => 196,  393 => 194,  387 => 191,  383 => 189,  381 => 188,  376 => 186,  371 => 183,  365 => 181,  361 => 179,  359 => 178,  351 => 173,  344 => 169,  340 => 168,  334 => 167,  327 => 165,  323 => 163,  318 => 162,  316 => 161,  297 => 144,  294 => 143,  290 => 142,  284 => 138,  278 => 137,  269 => 131,  265 => 129,  253 => 125,  249 => 123,  243 => 120,  239 => 118,  237 => 117,  232 => 115,  227 => 112,  221 => 110,  217 => 108,  215 => 107,  208 => 103,  204 => 102,  198 => 101,  191 => 99,  187 => 97,  182 => 96,  180 => 95,  161 => 78,  158 => 77,  154 => 76,  130 => 54,  128 => 53,  120 => 51,  117 => 50,  114 => 49,  111 => 48,  108 => 47,  105 => 46,  102 => 45,  100 => 44,  96 => 43,  93 => 42,  89 => 37,  78 => 34,  75 => 33,  71 => 32,  37 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("", "__string_template__b9a4cf809f2938a643a73df5fd189b3fe641d2b6c4fcab3ea0eb1747eb575bf5", "");
    }
}
