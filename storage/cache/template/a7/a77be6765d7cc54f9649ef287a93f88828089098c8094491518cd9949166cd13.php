...
/* __string_template__aa8572f17dd5b677ffc989bdb70a246560b7bb32bf900f255ff3f586e385cc55 */
class __TwigTemplate_cc710287a685b6bd5cf97770d9dcdfc39b27c2b21e73fe3709633c50aa93ecc1 extends Template
{
    private $source;
    private $macros = [];
...
$context["order"], "status", [], "any", false, false, false, 198) == "Delivered") && (twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, $context["order"], "status", [], "any", false, false, false, 198)) > 0))) {
      ...
      <div class=\"tab-pane fade show active\" id=\"tab-to-cancel\">
            ";
            // line 300
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable(($context["orders"] ?? null));
                ...
                <div class=\"table-responsive container mb-4\">
                  <table class=\"table table-bordered table-light\">
                    ...
                    <tbody>
                      ";
                    // line 314
                    $context["product_list"] = (((twig_get_attribute($this->env, $this->source, ($context["product_info"] ?? null), twig_get_attribute($this->env, $this->source, $context["order"], "order_id", [], "any", false, false, false, 314), [], "array", true, true, false, 314) &&  !(null === (($__internal_compile_8 = ($context["product_info"] ?? null)) && is_array($__internal_compile_8) || $__internal_compile_8 instanceof ArrayAccess ? ($__internal_compile_8[twig_get_attribute($this->env, $this->source, $context["order"], "order_id", [], "any", false, false, false, 314)] ?? null) : null)))) ? ((($__internal_compile_9 = ($context["product_info"] ?? null)) && is_array($__internal_compile_9) || $__internal_compile_9 instanceof ArrayAccess ? ($__internal_compile_9[twig_get_attribute($this->env, $this->source, $context["order"], "order_id", [], "any", false, false, false, 314)] ?? null) : null)) : ([]));
                    // line 315
                    echo "                      ";
                    $context['_parent'] = $context;
                    $context['_seq'] = twig_ensure_traversable(($context["product_list"] ?? null));
                  ...
                  <div class=\"d-flex justify-content-end\">
                    <button id=\"cancelOrderBtnFromPending\" data-tracking=\"";
                    // line 350
                    echo twig_get_attribute($this->env, $this->source, $context["order"], "order_id", [], "any", false, false, false, 350);
                    echo "\" class=\"btn btn-danger\">Cancel Order</button>
                  </div>
                </div>
...
\$(document).ready(function() {
    ...
    {
        return "__string_template__aa8572f17dd5b677ffc989bdb70a246560b7bb32bf900f255ff3f586e385cc55";
    }
