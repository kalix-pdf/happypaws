...
class __TwigTemplate_c6e018fa2ece2b63d682f6666aa14edc6c286ef7e80b60b4e30a0178dee05bd4 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t\t\t\t\t\t";
                // line 199
                echo (($__internal_compile_9 = $context["income_detail"]) && is_array($__internal_compile_9) || $__internal_compile_9 instanceof ArrayAccess ? ($__internal_compile_9["pfee_cfee"] ?? null) : null);
                echo "
\t\t\t\t\t\t\t\t\t\t\t\t</td>
\t\t\t\t\t\t\t\t\t\t\t\t<td class=\"text-center\">
\t\t\t\t\t\t\t\t\t\t\t\t\t";
