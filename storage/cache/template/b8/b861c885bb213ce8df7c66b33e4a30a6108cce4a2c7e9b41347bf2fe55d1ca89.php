...
/* __string_template__32be9f4ee202c8c391bd4a26a225aa84f62cf11135aa1e90d3df7d2165c9d77c */
class __TwigTemplate_8dd266ac77ef63f597aa9195478a26964e778707a5be200c7474b37a277d81cd extends Template
{
    private $source;
    private $macros = [];
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["order"]) {
                ...
                <div class=\"table-responsive container mb-4\">
                  ...
                  <tr>
                        ...
                        <td colspan=\"3\"><a class=\"text-decoration-none\" href=\"index.php?route=customerpartner/profile&seller_id=";
                    // line 371
                    echo twig_get_attribute($this->env, $this->source, ($context["prod"] ?? null), "seller_id", [], "any", false, false, false, 371);
                    echo "\">";
                    echo twig_get_attribute($this->env, $this->source, ($context["prod"] ?? null), "store", [], "any", false, false, false, 371);
                    echo " Shop</a></td>
                      </tr>
                      <tr class=\"text-right\">   
                        <a href=\"index.php?route=product/product&product_id=";
                    // line 374
                    echo twig_get_attribute($this->env, $this->source, ($context["prod"] ?? null), "product_id", [], "any", false, false, false, 374);
                    echo "\" class=\"btn btn-primary text-right\">Rate</a>
                      </tr>
                      <tr class=\"text-right\">   
                        <a href=\"index.php?route=account/order/info&order_id=";
                    // line 377
                    echo twig_get_attribute($this->env, $this->source, $context["order"], "order_id", [], "any", false, false, false, 377);
...
\$(document).ready(function() {
    ...
    {
        return "__string_template__32be9f4ee202c8c391bd4a26a225aa84f62cf11135aa1e90d3df7d2165c9d77c";
    }
