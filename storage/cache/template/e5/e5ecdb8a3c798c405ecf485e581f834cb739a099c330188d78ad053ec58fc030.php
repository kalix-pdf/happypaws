...
/* __string_template__d49b00a961cf3a90ac8a8bcc530c6f3de452cc4d34da7202eeef54980097f8f2 */
class __TwigTemplate_e0a08cf9953ad8ecab6c5622c46259576328a2cd72c87935b0489b5d3f88b893 extends Template
{
    private $source;
    private $macros = [];
        ...
        <div class=\"tab-pane fade show active\" id=\"tab-to-pay\">
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["order"]) {
                ...
                if (((twig_get_attribute($this->env, $this->source, $context["order"], "status", [], "any", false, false, false, 76) == "Pending") && (twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, $context["order"], "status", [], "any", false, false, false, 76)) > 0))) {
                    // line 77
                    echo "              <div class=\"card my-4 bg-dark\">
...
\$(document).ready(function() {
    ...
    {
        return "__string_template__d49b00a961cf3a90ac8a8bcc530c6f3de452cc4d34da7202eeef54980097f8f2";
    }
    ...
    {
        return new Source("", "__string_template__d49b00a961cf3a90ac8a8bcc530c6f3de452cc4d34da7202eeef54980097f8f2", "");
    }
}
