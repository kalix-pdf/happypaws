...
/* __string_template__721ebee24638d18f36cfd28d75056e3ba80ef5eb1b8af094c552ade8f7d659d9 */
class __TwigTemplate_711a4464b8c2dcf64cccf3e0696585e9aa05b86dc59705067f1eb8f4c858edd5 extends Template
{
    private $source;
    private $macros = [];
                  ...
                  <table class=\"table table-bordered table-light\">
                    ...
                    foreach ($context['_seq'] as $context["_key"] => $context["prod"]) {
                      ...
                      <tr>
                        ...
                        ";
                        // line 173
                        if ((twig_get_attribute($this->env, $this->source, $context["order"], "payment_method", [], "any", false, false, false, 173) == "hitpay")) {
                            // line 174
                            echo "                          <td colspan=\"3\">Online Payment</td>
                        ";
                        } else {
                            // line 176
                            echo "                          <td colspan=\"3\">";
                            echo twig_get_attribute($this->env, $this->source, $context["order"], "payment_method", [], "any", false, false, false, 176);
                            echo "</td>
                        ";
                        }
                        // line 178
                      ...
                      <tr>
                        ...
                        <td colspan=\"3\">";
                        // line 181
                        echo twig_get_attribute($this->env, $this->source, $context["order"], "payment_status", [], "any", false, false, false, 181);
                        echo "</td>
                      </tr>
                      ";
                        // line 183
                        if (twig_get_attribute($this->env, $this->source, $context["order"], "payment_url", [], "any", false, false, false, 183)) {
                            // line 184
                            echo "                      <tr class=\"table-danger\">
                        <td><strong>Payment Link:</strong></td>
                        <td colspan=\"3\"><a class=\"text-decoration-none btn btn-primary\" href=\"";
                            // line 186
                            echo twig_get_attribute($this->env, $this->source, $context["order"], "payment_url", [], "any", false, false, false, 186);
                            echo "\">Pay Order<a></td>
                      </tr>
                      ";
                        }
                        ...
                        <td colspan=\"3\"><a class=\"text-decoration-none\" href=\"index.php?route=customerpartner/profile&seller_id=";
                        // line 191
                        echo twig_get_attribute($this->env, $this->source, $context["prod"], "seller_id", [], "any", false, false, false, 191);
                        echo "\">";
                        echo twig_get_attribute($this->env, $this->source, $context["prod"], "store", [], "any", false, false, false, 191);
                        echo " Shop</a></td>
                      </tr>
                    </tbody>
                    ";
      ...
      ";
        ...
        <div class=\"tab-pane fade show\" id=\"tab-to-cancel\">
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["order"]) {
                // line 366
                echo "              ";
                if ((twig_get_attribute($this->env, $this->source, $context["order"], "status", [], "any", false, false, false, 366) == "Canceled")) {
                    // line 367
                    echo "              <div class=\"card my-4\">
                <div class=\"table-responsive container mb-4\">
                  <table class=\"table table-bordered table-light\">
                    ...
                    <tbody>
                      ";
                    // line 379
                    $context["product_list"] = (((twig_get_attribute($this->env, $this->source, ($context["product_info"] ?? null), twig_get_attribute($this->env, $this->source, $context["order"], "order_id", [], "any", false, false, false, 379), [], "array", true, true, false, 379) &&  !(null === (($__internal_compile_4 = ($context["product_info"] ?? null)) && is_array($__internal_compile_4) || $__internal_compile_4 instanceof ArrayAccess ? ($__internal_compile_4[twig_get_attribute($this->env, $this->source, $context["order"], "order_id", [], "any", false, false, false, 379)] ?? null) : null)))) ? ((($__internal_compile_5 = ($context["product_info"] ?? null)) && is_array($__internal_compile_5) || $__internal_compile_5 instanceof ArrayAccess ? ($__internal_compile_5[twig_get_attribute($this->env, $this->source, $context["order"], "order_id", [], "any", false, false, false, 379)] ?? null) : null)) : ([]));
                    // line 380
                    echo "                      ";
                    $context['_parent'] = $context;
                    $context['_seq'] = twig_ensure_traversable(($context["product_list"] ?? null));
                    foreach ($context['_seq'] as $context["_key"] => $context["prod"]) {
                      ...
                      <tr>
                        ...
                        ";
                        // line 391
                        if ((twig_get_attribute($this->env, $this->source, $context["order"], "payment_method", [], "any", false, false, false, 391) == "hitpay")) {
                            // line 392
                            echo "                          <td colspan=\"3\">Online Payment</td>
                        ";
                        } else {
                            // line 394
                            echo "                          <td colspan=\"3\">";
                            echo twig_get_attribute($this->env, $this->source, $context["order"], "payment_method", [], "any", false, false, false, 394);
                            echo "</td>
                        ";
                        }
                        // line 396
                      ...
                      <tr>
                        ...
                        <td colspan=\"3\"><a class=\"text-decoration-none\" href=\"index.php?route=customerpartner/profile&seller_id=";
                        // line 399
                        echo twig_get_attribute($this->env, $this->source, $context["prod"], "seller_id", [], "any", false, false, false, 399);
                        echo "\">";
                        echo twig_get_attribute($this->env, $this->source, $context["prod"], "store", [], "any", false, false, false, 399);
                        echo " Shop</a></td>
                      </tr>
                    </tbody>
                    ";
...
\$(document).ready(function() {
    ...
    {
        return "__string_template__721ebee24638d18f36cfd28d75056e3ba80ef5eb1b8af094c552ade8f7d659d9";
    }
    ...
    {
        return array (  610 => 526,  543 => 419,  536 => 415,  533 => 414,  531 => 413,  527 => 411,  522 => 408,  516 => 407,  510 => 403,  498 => 399,  493 => 396,  487 => 394,  483 => 392,  481 => 391,  474 => 387,  470 => 386,  466 => 385,  459 => 383,  455 => 381,  450 => 380,  448 => 379,  434 => 367,  431 => 366,  427 => 365,  423 => 363,  419 => 203,  413 => 202,  405 => 197,  401 => 195,  389 => 191,  385 => 189,  379 => 186,  375 => 184,  373 => 183,  368 => 181,  363 => 178,  357 => 176,  353 => 174,  351 => 173,  344 => 169,  340 => 168,  334 => 167,  327 => 165,  323 => 163,  318 => 162,  316 => 161,  297 => 144,  294 => 143,  290 => 142,  284 => 138,  278 => 137,  269 => 131,  265 => 129,  253 => 125,  249 => 123,  243 => 120,  239 => 118,  237 => 117,  232 => 115,  227 => 112,  221 => 110,  217 => 108,  215 => 107,  208 => 103,  204 => 102,  198 => 101,  191 => 99,  187 => 97,  182 => 96,  180 => 95,  161 => 78,  158 => 77,  154 => 76,  130 => 54,  128 => 53,  120 => 51,  117 => 50,  114 => 49,  111 => 48,  108 => 47,  105 => 46,  102 => 45,  100 => 44,  96 => 43,  93 => 42,  89 => 37,  78 => 34,  75 => 33,  71 => 32,  37 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("", "__string_template__721ebee24638d18f36cfd28d75056e3ba80ef5eb1b8af094c552ade8f7d659d9", "");
    }
}
