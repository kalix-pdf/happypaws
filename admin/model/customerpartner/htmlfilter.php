...
class ModelCustomerpartnerHtmlfilter extends Model {
    ...
    private function tln_sanitize(
        ...
        @array_walk($tag_list, array($this,'tln_casenormalize'));
        @array_walk($rm_tags_with_content, array($this,'tln_casenormalize'));
        @array_walk($self_closing_tags, array($this,'tln_casenormalize'));
        /**
