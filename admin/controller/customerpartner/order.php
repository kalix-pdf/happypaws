...
class ControllerCustomerpartnerOrder extends Controller
{
	...
	public function info()
	{
		...
		if ($order_info) {
			...
			$data['label_ship'] = $this->url->link('customerpartner/label&seller_id=' . (int)$this->request->get['seller_id'] . '&order_id=' . $order_id, 'user_token=' . $this->session->data['user_token'], true);
