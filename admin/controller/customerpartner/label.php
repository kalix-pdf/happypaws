...
class ControllerCustomerpartnerLabel extends Controller {
	...
	public function index() {
		...
		$shippingTotal = $this->model_customerpartner_order->getOrderTotals($order_id);
		...
		if ($order_info) {
            ...
            if (isset($shippingTotal[0]['shipping_applied'])) {
                $data['shipping_applied'] = $this->currency->format($shippingTotal[0]['shipping_applied'], $order_info['currency_code'], $order_info['currency_value']);
            }
