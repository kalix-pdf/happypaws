...
class Controllercustomerpartnerdashboardsrecent extends Controller {
	...
	public function index() {
		...
		$results = $this->model_customerpartner_customerpartner->getSellerOrders($customer_id,$filter_data);

		foreach ($results as $result) {
			$order_total = $this->model_customerpartner_dashboard->getTotalSales($customer_id,array('filter_order_id' => $result['order_id']));
