...
class ControllerAccountCustomerpartnerDashboardsOrderstatus extends Controller
{
	...
	public function index()
	{
		...
		$data['totalProcessing'] = $this->model_customerpartner_dashboard->totalSellerOrder(array('filter_processing_order' => $this->config->get('marketplace_proccessing_order_status')));
		...
		$data['processing_order_link'] = $this->url->link('account/customerpartner/orderlist&filter_status=' . $this->config->get('marketplace_proccessing_order_status'), '', true);
