...
use Google\Service\Spanner\IndexAdvice;
class ControllerExtensionWebhookCourier extends Controller {
    private function logWebhook($message)
    {
        $logFile = DIR_LOGS . 'webhookCourier.log'; 
    ...
    public function index() {
        $log_file = DIR_LOGS . 'webhookCourier.log';
        $flash_mchId = 'CA0740';
