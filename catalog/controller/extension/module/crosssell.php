...
class ControllerExtensionModuleCrosssell extends Controller {
	public function index() {
		...
		$data['cheader2'] = html_entity_decode(!empty($this->config->get('wk_clisting_crossselling_details2')) ? $this->config->get('wk_clisting_crossselling_details2')[$language_id] : '');
