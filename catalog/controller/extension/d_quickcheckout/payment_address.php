    ...
    private function getDefault($populate = true){
        ...
        if($populate){
            ...
            && !empty(current($state['session']['addresses'])['address_id'])){
                if (isset($state['session']['payment_address']['address_id']) && (int)$state['session']['payment_address']['address_id'] != 0 && !empty($state['session']['addresses'][$state['session']['payment_address']['address_id']]) && !$clear_session) {
                ...
                } else if (((isset($state['session']['payment_address']['address_id']) && (int)$state['session']['payment_address']['address_id'] != 0 && empty($state['session']['addresses'][$state['session']['payment_address']['address_id']])) || !isset($state['session']['payment_address']['address_id'])) && !$clear_session) {
