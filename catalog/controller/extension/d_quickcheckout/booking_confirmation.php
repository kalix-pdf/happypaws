...
class ControllerExtensionDQuickcheckoutBookingConfirmation extends Controller{
    private $route = 'extension/d_quickcheckout/booking_confirmation';
    ...
    public function update(){
        ...
        $this->model_extension_d_quickcheckout_store->dispatch('booking_confirmation/update/before', $post);
        $this->model_extension_d_quickcheckout_store->dispatch('booking_confirmation/update', $post);
